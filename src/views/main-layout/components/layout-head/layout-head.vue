<template>
  <div class="layout-Head">
    <div class="fixed-head">
      <h1 class="head-logo">
        <img
          src="https://deepexi.oss-cn-shenzhen.aliyuncs.com/spaas-console/logo_SPaaS_white.png"
          alt="xPaaS"
          class="layout-logo"
        />
      </h1>
  ...
  computed: {
    ...
    userImg() {
      return (
        ...
        'https://deepexi.oss-cn-shenzhen.aliyuncs.com/spaas-console/user-portrait.png'
      )
    },
    ...mapMutations(['logout'])
  },
