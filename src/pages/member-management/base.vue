<template>
  <div class="member-edit" v-loading="pageLoading">
    ...
    ></el-form-renderer>
    <!-- <el-row class="member-edit-group">
      <el-col :span="2" class="member-edit-label">证件类型 &nbsp</el-col>
      <el-col :span="20">
          <el-select v-model="cardInfo.type" placeholder="请选择">
            <el-option
    ...
    <el-row class="member-edit-group">
      <el-col :span="2" class="member-edit-label">证件号码 &nbsp</el-col>
      <el-col :span="20">
          <el-input v-model="cardInfo.cardNumber" placeholder="请输入"></el-input>
      </el-col>
    </el-row>
    
    <el-row class="member-edit-group">
      <el-col :span="2" class="member-edit-label">证件正面 &nbsp</el-col>
      <el-col :span="20">
          <upload-to-ali accept="image/png, image/jpeg, image/jpg"
                         :compressOptions="{}"
                         v-model="cardInfo.cardPositive">
          </upload-to-ali>
      </el-col>
    </el-row>
    <el-row class="member-edit-group">
      <el-col :span="2" class="member-edit-label">证件反面 &nbsp</el-col>
      <el-col :span="20">
          <upload-to-ali accept="image/png, image/jpeg, image/jpg"
                         :compressOptions="{}"
                         v-model="cardInfo.cardNegative">
          </upload-to-ali>
      </el-col>
    </el-row>
    <el-row class="member-edit-group" v-for="(item,index) in otherCard" :key="index">
      <el-col :span="2" class="member-edit-label">{{item.label}} &nbsp</el-col>
      <el-col :span="20">
          <upload-to-ali accept="image/png, image/jpeg, image/jpg"
                         :compressOptions="{}"
                         v-model="item.url">
          </upload-to-ali>
          <span class="el-icon-error removeImg" @click="removeImg(index)"></span>
      </el-col>
    </el-row> -->
    <el-row>
